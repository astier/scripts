...
apt update
apt install arc-theme build-essential deborphan dropbox ffmpeg flat-remix fonts-hack-ttf libx11-dev libxft-dev neovim nodejs pulsemixer tmux xsel yarn
